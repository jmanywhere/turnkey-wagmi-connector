...
const pitfalls = [
  ...
  },
  {
    ...
    body: "This workspace uses the source package directly. Keep peer dependencies aligned, client wallet providers isolated to the app tree, and transpile workspace packages when consuming source.",
  },
];
    ...
    <div className="grid gap-16">
      ...
      <section id="providers" className="grid gap-6">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground">
          This workspace app also wraps Reown AppKit and uses{" "}
      ...
      <section id="api" className="grid gap-6">
        ...
        <div>
          <p className="mb-2 text-sm font-medium">Typical hook usage:</p>
      ...
      <section id="lifi" className="grid gap-4">
        <div>
          ...
          <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
            Proves the workspace connector drives Wagmi correctly inside the

    ...
    return (
        <div className="route-layout stack">
            <header className="route-header">
                <div className="stack">
                    <p className="eyebrow">NPM Acceptance Demo</p>
                    <h1>
                        LI.FI widget recognition with the published connector package.
                    </h1>
                    <p className="text-muted">
                        This fixture installs <code>turnkey-wagmi-connector</code>{" "}
                        from npm. The Turnkey embedded wallet still auto-connects
                        into Wagmi after auth, and Reown AppKit can still replace
                        it with an external wallet without bypassing Turnkey
                        session authority.
                    </p>
                </div>
